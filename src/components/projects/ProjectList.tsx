        ...
        <table className="w-full text-left text-sm whitespace-nowrap">
          ...
          >
            {projects.map((project) => {
              ...
              return (
                <motion.tr variants={staggerItem} key={project.id} className="hover:bg-slate-50/50 transition-colors group">
                  <td className="px-6 py-4">
                    <Link to={`/projects/${project.id}`} className="font-semibold text-foreground hover:text-brand transition-colors">
                      {project.name}
                    </Link>
                  </td>
                  ...
                  <td className="px-6 py-4">
                    <Badge className={isArchived ? "bg-slate-100 text-slate-600 hover:bg-slate-200 border-transparent shadow-none" : "bg-emerald-50 text-emerald-600 hover:bg-emerald-100 border-transparent shadow-none"}>
