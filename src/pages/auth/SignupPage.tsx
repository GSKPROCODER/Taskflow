...
import { signUpWithPassword, signInWithGoogle, signInWithGithub } from "@/lib/auth";
    ...
    >
      <div className="grid gap-4">
        ...
        <div className="grid gap-2">
          ...
          <Button variant="outline" type="button" className="w-full" onClick={handleGithubSignUp}>
