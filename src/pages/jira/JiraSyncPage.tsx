  ...
  return (
    <Card className="group p-4 shadow-sm shadow-slate-200/50 border-border bg-card rounded-xl transition-all duration-300 hover:-translate-y-1 hover:shadow-md hover:border-brand/30 cursor-grab active:cursor-grabbing">
      <div className="flex flex-col space-y-3">
        <p className="text-sm font-medium text-foreground leading-snug">{issue.summary}</p>
        
        <div className="flex items-center justify-between pt-2">
          <div className="flex items-center gap-3">
            <span className="text-xs font-bold text-brand hover:underline cursor-pointer">{issue.id}</span>
            <PriorityMarker priority={issue.priority} />
          </div>
          
          <Avatar className="size-6 bg-secondary text-white border-none shadow-sm">
            <AvatarFallback className={cn("text-[10px]", avatarColor(issue.assignee))}>
              {initials}
            </AvatarFallback>
          </Avatar>
        </div>
  ...
  return (
    <div className="flex flex-col h-full space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          <h1 className="text-2xl font-bold tracking-tight text-foreground">Jira Board</h1>
          <p className="text-sm font-medium text-muted-foreground mt-1">Project: TaskFlow Core Engine (TF)</p>
        </div>
        
        <div className="flex items-center gap-3">
          <Button variant="outline" className="bg-card text-foreground border-border hover:bg-secondary shadow-sm">
            Sync Status
          </Button>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 flex-1 min-h-0 pb-4">
        ...
        <div className="flex flex-col h-full bg-secondary/30 rounded-2xl p-4 border border-border/50">
          <div className="flex items-center justify-between mb-4 px-1">
            <h3 className="text-sm font-bold text-slate-500 uppercase tracking-wider">To Do</h3>
        ...
        <div className="flex flex-col h-full bg-secondary/30 rounded-2xl p-4 border border-border/50">
          <div className="flex items-center justify-between mb-4 px-1">
            <h3 className="text-sm font-bold text-blue-500 uppercase tracking-wider">In Progress</h3>
        ...
        <div className="flex flex-col h-full bg-secondary/30 rounded-2xl p-4 border border-border/50">
          <div className="flex items-center justify-between mb-4 px-1">
            <h3 className="text-sm font-bold text-emerald-500 uppercase tracking-wider">Done</h3>
